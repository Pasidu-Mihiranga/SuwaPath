  ...
  theme: {
    extend: {
      colors: {
        ...
        line: "var(--sp-border)",
        ok: { surface: "var(--sp-ok-surface)", border: "var(--sp-ok-border)", text: "var(--sp-ok-text)", solid: "var(--sp-ok-solid)" },
        warn: { surface: "var(--sp-warn-surface)", border: "var(--sp-warn-border)", text: "var(--sp-warn-text)", solid: "var(--sp-warn-solid)" },
        danger: { surface: "var(--sp-danger-surface)", border: "var(--sp-danger-border)", text: "var(--sp-danger-text)", solid: "var(--sp-danger-solid)" },
